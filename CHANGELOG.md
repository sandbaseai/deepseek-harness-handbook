...
- Finalized the machine-readable pointer alignment for v0.5.438.
...
- Aligned the machine-readable latest-release pointers with v0.5.436.

## 0.5.435 - 2026-08-29

### Fixed

- Backfilled the public changelog through v0.5.434 so release tags and documented iterations have one auditable history.
...
- Advanced the LLM index and Atom feed pointers to the latest citation and backlink release.
