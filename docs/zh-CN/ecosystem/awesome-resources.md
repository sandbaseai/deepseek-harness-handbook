...
| 插件组合示例 | [dsh-cordis-rocks（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 上游目录记录了可运行 Cordis 教程；安装前先确认仓库当前是否可见。 |
| 查找插件 | [dsh-find-plugins（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 上游目录记录了发现工具；安装前先确认仓库当前是否可见。 |
...
| 能力 | 资源 | 用途 |
|---|---|---|
| Session 修复 | [dsh-session-repair-skill（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了先读后写的修复流程；安装前先确认仓库当前是否可见。 |
| Session 健康检查 | [dsh-session-health](https://github.com/dsh-external/dsh-session-health) | 扫描多帧 Zstandard Session 文件，发现撕裂、空文件或损坏。 |
| 跨 Session 记忆 | [dsh-memory（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了长期记忆插件；先确认仓库可见性并检查 prompt 注入边界。 |
...
| 跨工具 Session 导入 | [dsh-session-hub（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了跨工具历史导入；安装前先确认仓库当前是否可见。 |
...
| 能力 | 资源 | 用途 |
|---|---|---|
| plan/execute 路由 | [dsh-plan-execute（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了规划与执行分离；安装前先确认仓库当前是否可见。 |
...
| GitHub 凭据桥 | [dsh-gh-bridge（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了 Keychain 桥；必须确认仓库可见性并审计 secret 范围。 |
...
| 能力 | 资源 | 用途 |
|---|---|---|
| 浏览器面板 | [dsh-browser-panel（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了可见浏览器面板；安装前先确认仓库当前是否可见。 |
| Office 文件 | [dsh-office（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了 Office 文件工作流；安装前先确认仓库当前是否可见。 |
| 设计工作流 | [dsh-design（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了设计 Agent 工作流；安装前先确认仓库当前是否可见。 |
...
| Pi 桥接 | [dsh-pi-adapter（目录快照）](https://github.com/0xsline/awesome-deepseek-harness/blob/07278233cba25e6f2d011018751187b7a4d8ed52/CATALOG.md) | 目录记录了 Pi 桥；安装前先确认仓库当前是否可见。 |
